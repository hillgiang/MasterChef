...
public class MasterchefAdapter extends RecyclerView.Adapter<MasterchefAdapter.MyViewHolder> {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(mContext,MemberPage.class);
                    intent.putExtra("USER_ID", id);
                    intent.putExtra("USERNAME", title_str);
    ...
    public MasterchefAdapter(Context mContext, ArrayList<HashMap<String, String>> list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load(masterchef.get(GetMasterchef.KEY_THUMBNAIL))
                .thumbnail(0.5f)
                .crossFade()
