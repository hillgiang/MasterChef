...
public class MemberPageVideoTab extends Fragment {
    private RecyclerView recyclerView;
    private VideoAdapter adapter;
    SessionManagement session;

    public MemberPageVideoTab() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new GetMyVideo(this).execute(((User)getActivity()).username());
        return v;
    }

    public class GetMyVideo extends AsyncTask<String, String, String> {
        private MemberPageVideoTab context;
        String task;

        public GetMyVideo(MemberPageVideoTab context) {
